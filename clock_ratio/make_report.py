...
def main() -> int:
    ...
    if stat is not None:
        ...
        L.append("|---|---|---|---|")
        L.append(f"| WLS（1/u_i²） | {stat['R_wls_precision'][:20]} | {stat['u_wls']:.3e} | {stat['grav_wls']:+.3e} |")
        L.append(f"| Birge（B={stat['birge_ratio']:.3f}，1/u_i²） | {stat['R_wls_precision'][:20]} | {stat['u_birge']:.3e} | {stat['grav_birge']:+.3e} |")
