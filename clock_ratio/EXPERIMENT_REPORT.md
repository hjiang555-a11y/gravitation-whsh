...
>
> **整个实验的 Yb/Sr 值（时长加权中心值）**：**1.207507039343337720**（R_duration = `1.2075070393433377203695609768033054790406356472332098683511270165437806214827708`）。
...
1. **整个实验的钟比值（时长加权中心值）**：R_duration = `1.207507039343337720`，与 NIST `1.2075070393433377230(37)` 差 -2.63×10⁻¹⁸，与实验方 WLS `1.2075070393433377213(23)` 差 -0.93×10⁻¹⁸。逐段 y_i ∈ [-4.6, 6.4]×10⁻¹⁸。
...
| 维度 | 结果 |
|---|---|
| 整个实验 Yb/Sr 值 | R_duration = 1.207507039343337720，与实验方 WLS 差 -0.93×10⁻¹⁸ |
...
|---|---|---|---|
| WLS（1/u_i²） | 1.207507039343337720 | 2.753e-19 | -3.159e-19 |
| Birge（B=2.324，1/u_i²） | 1.207507039343337720 | 6.399e-19 | -3.159e-19 |
| Mandel-Paule（ξ=2.465e-18，1/(u_i²+ξ²)） | 1.207507039343337721 | 7.551e-19 | -4.408e-19 |
| 贝叶斯（ξ=2.613e-18） | 1.207507039343337721 | 8.004e-19 | -4.433e-19 |
