...
| 情景 | A | WLS R（17段→16段） | χ²_red（17段→16段） | Birge（17段→16段） |
|---|---|---|---|---|
| raw | 0 | 1.20750703934333772079→1.20750703934333772014 | 5.424→2.684 | 2.329→1.638 |
| theory | -1 | 1.20750703934333772168→1.20750703934333772110 | 3.699→2.821 | 1.923→1.680 |
| empirical | -0.54 | 1.20750703934333772125→1.20750703934333772062 | 4.559→2.919 | 2.135→1.709 |
...
> 同时三情景的 WLS 中心值都整体下移约 −0.6×10⁻¹⁸，最接近实验方 WLS 的情景从
> 17 段时的 empirical 变为 16 段时的 theory（|偏差| 0.20×10⁻¹⁸）。
